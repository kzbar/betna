            ...
            slivers: [
              ...
              Consumer<PropertyProvider>(
                builder: (context, provider, child) {
                  final projectItems = provider.properties
                      .where((p) => p.category == 'project')
                      .toList();

                  if (provider.isLoading && projectItems.isEmpty) {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              s.kProjectsSectionTitle.toUpperCase(),
                  ...
                  children: [
                    if (property.imageUrl.isNotEmpty ||
                      ...
                      Container(
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              Style.primaryMaroon.withValues(alpha: 0.4),
                              Style.luxuryCharcoal,
                            ],
                    ...
                    if (property.imageUrl.isEmpty && property.images.isEmpty)
                      Center(
                        child: Opacity(
                          opacity: 0.2,
                          child: Logo(hi: 60, we: 150, withBackground: false),
                        ),
                      ),
                    // Sold Badge
                    if (property.isSold)
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            "From ${property.currency} ${property.price.toInt()}",
      ...
      child: Center(
        child: Column(
          children: [
            ...
            const SizedBox(height: 24),
            Text(
              "© ${intl.DateFormat('yyyy').format(DateTime.now())} Betna Gayrimenkul. All rights reserved.",
              style: Theme.of(context).textTheme.bodySmall?.copyWith(
                color: Colors.white.withValues(alpha: 0.5),
              ),
            ),

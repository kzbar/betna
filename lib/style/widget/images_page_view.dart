...
import 'package:betna/style/widget/image_view.dart';
...
class ImagePageView extends StatefulWidget {
  ...
  const ImagePageView({super.key, this.images, required this.tag});
...
class _ImagePageViewState extends State<ImagePageView>
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                ...
                icon: Icon(autoPlay ? Icons.pause : Icons.play_arrow_outlined),
                color: Colors.white,
              ),
              const Spacer(),
              Container(
  ...
  _animateToIndex(i, w) => _controller.animateTo(
    w * i,
